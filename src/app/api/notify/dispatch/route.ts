...
// `notifications` (INSERT). Meneruskan notifikasi in-app ke email + WhatsApp
// penerimanya. Mencakup pengingat real-time:
//   - DPJP: entri/karya menunggu verifikasi (type entri_baru / karya_baru)
//   - Residen: entri diverifikasi / diminta revisi (type entri_*)
//
